...
void myAlert(string type, string message)
{
  ...
  {
    Print(type + " | TC_chartIndicatorEAExtend @ " + Symbol() + "," + IntegerToString(Period()) + " | " + message);
  }
  else if (type == "order")
  {
  }
...
bool WithdrawDayOfWeek(int day)
{

  return (
      (WithdrawMonday && day == 1) || (WithdrawTuesday && day == 2) || (WithdrawWednesday && day == 3) || (WithdrawThursday && day == 4) || (WithdrawFriday && day == 5) || (WithdrawSaturday && day == 6) || (WithdrawSunday && day == 7));
}
